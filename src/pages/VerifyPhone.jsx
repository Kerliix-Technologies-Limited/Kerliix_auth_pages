  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Secure your account by verifying your phone number." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={window.location.href} />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Verify Your Phone - Kerliix" />
        <meta name="twitter:description" content="Verify your phone number to complete setup." />
      </Helmet>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-blue-900 via-black to-gray-900">
        <div className="bg-white/10 p-8 rounded-lg shadow-lg w-full max-w-md backdrop-blur-md border border-white/20 text-white">
          ...
          <p className="mb-6 text-center text-lg">
            Enter the 6-digit code sent to your phone to verify your number.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="mt-4 text-center text-sm text-gray-300">
              ...
              <button
                ...
                onClick={() => toast.info('Resend SMS feature coming soon!')}
              >
                Resend code
              </button>
            </p>
